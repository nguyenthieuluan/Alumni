...
export class EventPlanServiceProxy {
     ...
     * @return Success
     */
    deleteEvent(model: EventPlanDetailDto | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/EventPlan/DeleteEvent";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeleteEvent(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PageServiceProxy {
     ...
     * @return Success
     */
    addPageCreateCredit(request: PageCreateCredit | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Page/AddPageCreateCredit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddPageCreateCredit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddPageCreateCredit(<any>response_);
                } catch (e) {
    ...
    protected processAddPageCreateCredit(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PostServiceProxy {
     ...
     * @return Success
     */
    editPostComment(model: PostCommentDetailDto | null | undefined): Observable<PostCommentDetailDto> {
        let url_ = this.baseUrl + "/api/services/app/Post/EditPostComment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditPostComment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditPostComment(<any>response_);
                } catch (e) {
                    return <Observable<PostCommentDetailDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processEditPostComment(response: HttpResponseBase): Observable<PostCommentDetailDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deletePostComment(model: PostCommentDetailDto | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Post/DeletePostComment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeletePostComment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeletePostComment(<any>response_);
                } catch (e) {
                    return <Observable<boolean>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeletePostComment(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class SeachServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    quickSearch(request: SearchRequest | null | undefined): Observable<SearchResult> {
        let url_ = this.baseUrl + "/api/services/app/Seach/QuickSearch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processQuickSearch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processQuickSearch(<any>response_);
                } catch (e) {
    ...
    protected processQuickSearch(response: HttpResponseBase): Observable<SearchResult> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? SearchResult.fromJS(resultData200) : new SearchResult();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    userSearch(request: SearchRequest | null | undefined): Observable<PagedResultDtoOfUserProfileDto> {
        let url_ = this.baseUrl + "/api/services/app/Seach/UserSearch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUserSearch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUserSearch(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfUserProfileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUserSearch(response: HttpResponseBase): Observable<PagedResultDtoOfUserProfileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    pageSearch(request: SearchRequest | null | undefined): Observable<PagedResultDtoOfPageDetailDto> {
        let url_ = this.baseUrl + "/api/services/app/Seach/PageSearch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPageSearch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPageSearch(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfPageDetailDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfPageDetailDto>><any>_observableThrow(response_);
        }));
    }

    protected processPageSearch(response: HttpResponseBase): Observable<PagedResultDtoOfPageDetailDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfPageDetailDto.fromJS(resultData200) : new PagedResultDtoOfPageDetailDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfPageDetailDto>(<any>null);
    }
}
...
export class PageCreateCredit implements IPageCreateCredit {
    userId: number | undefined;
    credit: number | undefined;

    constructor(data?: IPageCreateCredit) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PageCreateCredit {
        data = typeof data === 'object' ? data : {};
        let result = new PageCreateCredit();
        result.init(data);
        return result;
    }
...
export interface IPageCreateCredit {
    userId: number | undefined;
    credit: number | undefined;
}
...
export class SearchResult implements ISearchResult {
    userResults: PagedResultDtoOfUserProfileDto | undefined;
    pageResults: PagedResultDtoOfPageDetailDto | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.userResults = data["userResults"] ? PagedResultDtoOfUserProfileDto.fromJS(data["userResults"]) : <any>undefined;
            this.pageResults = data["pageResults"] ? PagedResultDtoOfPageDetailDto.fromJS(data["pageResults"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["userResults"] = this.userResults ? this.userResults.toJSON() : <any>undefined;
        data["pageResults"] = this.pageResults ? this.pageResults.toJSON() : <any>undefined;
        return data; 
    }
...
export class PagedResultDtoOfPageDetailDto implements IPagedResultDtoOfPageDetailDto {
    totalCount: number | undefined;
    items: PageDetailDto[] | undefined;

    constructor(data?: IPagedResultDtoOfPageDetailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(PageDetailDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfPageDetailDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfPageDetailDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfPageDetailDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfPageDetailDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfPageDetailDto {
    totalCount: number | undefined;
    items: PageDetailDto[] | undefined;
}
