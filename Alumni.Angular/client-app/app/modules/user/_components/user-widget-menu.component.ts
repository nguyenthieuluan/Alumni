...
import { ConfigurationServiceProxy, UserInfoDto, UserProfileDto, UserProfileServiceProxy, UserPagesDto } from "@shared/service-proxies/service-proxies";
...
export class UserWidgetMenuComponent extends AppComponentBase implements OnInit {
