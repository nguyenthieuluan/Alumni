...
import { PostDetailDto, PostServiceProxy, UserTimelinePostRequest, UserProfileDto } from "@shared/service-proxies/service-proxies";
...
export class UserTimelineComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this._postService.getUserTimelinePosts(this.request).finally(
